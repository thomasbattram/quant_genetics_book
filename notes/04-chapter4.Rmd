...
6. Assuming a trait was entirely influenced by a single locus, how could you calculate dominance and additive effects knowing the genotypic value and the number of effect alleles?
...
9. How does the contribution of additive genetic variance contribute to total genetic variance when $k$ varies?
