...
1. True of false, if $\sigma(x,y) = 0$, $x$ and $y$ are independent
...
\begin{align}
  ...
  \sigma^2(x + y) &= ... \notag \\
\end{align}
3. Name 4 important properties of least-squares regression
4. Give an assumption of the correlation coefficient
5. How can you work out $h^2$ from trio data? 
6. Give two definitions of the breeders' equation.
